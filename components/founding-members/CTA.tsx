  ...
  return (
    <section className="relative overflow-hidden bg-[#050505] py-32">
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center lg:px-12">
        ...
        <h2 className="mt-8 text-5xl font-bold leading-tight tracking-tight text-white md:text-6xl xl:text-7xl">
          We're Not Looking
          <br />
          For Employees.
        </h2>

        <h3 className="mt-6 text-4xl font-bold leading-tight tracking-tight text-yellow-400 md:text-5xl">
        ...
        <p className="mx-auto mt-10 max-w-3xl text-lg leading-9 text-zinc-400 md:text-xl">
          Join a select group of professionals, entrepreneurs, engineers,
          investors and innovators committed to building South Africa's first
